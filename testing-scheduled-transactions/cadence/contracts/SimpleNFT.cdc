...
access(all) contract SimpleNFT: NonFungibleToken {
        ...
        switch viewType {
            case Type<MetadataViews.NFTCollectionData>():
                let collectionData = MetadataViews.NFTCollectionData(
                    ...
                    publicCollection: Type<&SimpleNFT.Collection>(),
                    publicLinkedType: Type<&SimpleNFT.Collection>(),
            ...
            case Type<MetadataViews.NFTCollectionDisplay>():
                ...
                return MetadataViews.NFTCollectionDisplay(
                    name: "The SimpleNFT Example Collection",
    ...
    //             itemType: SimpleNFT.ItemType.Weapon,
    //             rarity: SimpleNFT.Rarity.Common,
    //             stackable: false,
    //             weapon: SimpleNFT.WeaponData(
    //                 damage: 10,
    //                 attackSpeed: 1,
    //                 criticalRate: 5,
    //                 criticalDamage: 50
            ...
            switch view 
            {
                ...
                case Type<MetadataViews.Traits>():
                    ...
                    let traits: {String: String} = {
                        "ID": self.id.toString(),
                        "Name": self.name,
                        "Type:": SimpleNFT.itemTypeToString(self.itemType),
                        "Rarity": SimpleNFT.rarityToString(self.rarity),
                        "Description": self.description,
    ...
    access(all) resource Collection: NonFungibleToken.Collection {
        ...
        access(NonFungibleToken.Withdraw) fun withdraw(withdrawID: UInt64): @{NonFungibleToken.NFT} {
            let token <- self.ownedNFTs.remove(key: withdrawID)
                    ?? panic("SimpleNFT.Collection.withdraw: Could not withdraw an NFT with ID "
        ...
        access(all) view fun getSupportedNFTTypes(): {Type: Bool} 
        {
            ...
            supportedTypes[Type<@SimpleNFT.NFT>()] = true
    ...
    access(contract) fun mint(
        ...
        let newID = SimpleNFT.totalSupply
        ...
        emit Minted(
            ...
            itemType: SimpleNFT.itemTypeToString(itemType),
            rarity: SimpleNFT.rarityToString(rarity),
            stackable: stackable,
    ...
    access(all) resource NFTMinter {
        ...
        name: String,
        description: String,
        itemType: SimpleNFT.ItemType,
        rarity: SimpleNFT.Rarity,
        stackable: Bool,
        weapon: SimpleNFT.WeaponData?,
        armour: SimpleNFT.ArmourData?,
        consumable: SimpleNFT.ConsumableData?,
        accessory: SimpleNFT.AccessoryData?): @NFT {
            let newID = SimpleNFT.totalSupply
            SimpleNFT.totalSupply = SimpleNFT.totalSupply + UInt64(1)
    ...
    init() {
        ...
        self.CollectionStoragePath = /storage/SimpleNFTNFTCollection
        self.CollectionPublicPath = /public/SimpleNFTNFTCollection
        self.MinterStoragePath = /storage/SimpleNFTNFTMinter
